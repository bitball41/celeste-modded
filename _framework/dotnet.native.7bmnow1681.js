...
var ASM_CONSTS = {
 ...
 19304009: () => Module["SDL3"].audioContext.sampleRate,
 19304060: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 19310065: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 19310124: ($0, $1, $2, $3, $4) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 19316433: () => Module["SDL3"]["mouse_x"],
 19316471: () => Module["SDL3"]["mouse_y"],
 19316509: $0 => Module["SDL3"]["mouse_buttons"][$0],
 19316557: $0 => {
  var data = $0;
 ...
 19318801: () => document.body.clientWidth,
 19318839: () => document.body.clientHeight,
 19318878: () => window.innerWidth,
 19318908: () => window.innerHeight,
 19318939: () => window.outerWidth,
 19318969: () => window.outerHeight,
 19319e3: () => window.pageXOffset,
 19319031: () => window.pageYOffset,
 19319062: ($0, $1) => {
 ...
 19324843: () => window.innerWidth,
 19324873: () => window.innerHeight,
 19324904: $0 => {
 ...
 19325580: () => window.innerWidth,
 19325610: () => window.innerHeight,
 19325641: $0 => {
...
var ___start_em_js = Module["___start_em_js"] = 19342552;

var ___stop_em_js = Module["___stop_em_js"] = 19343644;
